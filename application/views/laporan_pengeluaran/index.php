<div class="col-lg-4">
    <div class="card card-widget">
        <div class="card-body">
            <form action="<?= base_url('laporan_pengeluaran/lap_pengeluaran'); ?>" method="POST">
                ...
                <a href="<?= base_url('laporan_pengeluaran/cetak_semua'); ?>" class="btn btn-primary">Cetak Semua</a>
            </form>
        </div>
    </div>
</div>